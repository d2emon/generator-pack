...
class TreeThought(ThingBuilder):
    model = models.TreeThought
...
class TreeThoughts(ThingBuilder):
    model = models.TreeThoughts
...
class TreeTrunk(ThingBuilder):
    model = models.TreeTrunk
...
class JungleTree(Tree):
    model = models.JungleTree


class Humus(ThingBuilder):
    model = models.Humus
