from .bacteria import bacteria_types, bacteria_subtypes, bacteria_thoughts
from .cetacean import cetaceans, cetacean_thoughts
from .clam import clams, clam_thoughts
