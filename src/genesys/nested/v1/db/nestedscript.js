...
Instance.prototype.Name=function()
{
	...
	else if (this.name=="*SADTHOUGHT*")
	{
		...
		Choose(["My "+Choose(["butt","nose","foot","ear","forehead","back"])+" is itchy.","My "+Choose(["head","leg","arm","belly","back","shoulder"])+" "+Choose(["feels weird","feels icky","hurts","feels strange"])+".","I should see a doctor for my "+Choose(["eyes","mind","head","chest","legs","back"])+"."]),
