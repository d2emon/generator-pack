...
from genesys.nested.data.biology.life import CONTENTS as LIFE_CONTENTS
from genesys.nested.data.biology.monsters import CONTENTS as MONSTERS_CONTENTS
from genesys.nested.data.terrain import CONTENTS as TERRAIN_CONTENTS
from genesys.nested.data.state import CONTENTS as STATE_CONTENTS
from genesys.nested.data.room import CONTENTS as ROOM_CONTENTS
from genesys.nested.data.furniture import CONTENTS as FURNITURE_CONTENTS

from genesys.nested.data.person import CONTENTS as PERSON_CONTENTS

from genesys.nested.data.medieval import CONTENTS as MEDIEVAL_CONTENTS
