...
class OldNames(Names):
    nm83 = ["Delmon","Karcsi","Quesnel","Aaron","Abdiel","Abdullah","Abel","Abelard","Abilo",
    "Abraham","Abram","Acel","Achille","Achilles","Achilleus","Achim","Achmed","Ackerley","Ackley",
    "Acton","Adalard","Adalbero","Adalbert","Adalbrecht","Adalwine","Adam","Adan","Addi","Addisen",
