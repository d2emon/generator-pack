from genesys.fng.factories.description.character.hair import MaleHairFactory, FemaleHairFactory
from genesys.fng.factories.description.character.face import FaceFactory
from genesys.fng.factories.description.character.eyes import EyesFactory
from ..promise import PromiseFactory
from genesys.fng.factories.description.character.name import MaleNameFactory, FemaleNameFactory
