...
from genesys.fng.factories import BeltGenerator, FemaleBeltGenerator
from genesys.fng.factories import PantsGenerator
from genesys.fng.factories import ShoesGenerator
from genesys.fng.factories import DressGenerator


class Clothing(DescriptiveModel, GeneratedModel):
