...
from fixtures.tools.outfit.belt import belt
from fixtures.tools.outfit.gloves import gloves
from fixtures.tools.outfit.jacket import jacket
from fixtures.tools.outfit.pants import pants
...
from fixtures.tools.outfit.skirt import skirt
