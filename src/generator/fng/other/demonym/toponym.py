...
from generator.generator.data_provider import FileProvider, ListProvider

from fixtures.other.alphabet import vowel_sounds, consonants, double_vowel_sounds, double_consonants
from fixtures.other.toponym import endings
