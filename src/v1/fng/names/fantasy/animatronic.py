       ...
       [["Echo the", "Eclipse the", "Edge the", "Elmo the", "Elwood the", "Equinox the", "Ernie the", "Excalibur the"],
        ["Elf", "Eagle", "Elephant"]], [
           ...
           ["Sabath the", "Saber the", "Salt the", "Salty", "Satin the", "Saul the", "Savage the", "Sawyer the",
            ...
            "Shadow the", "Shamrock the", "Shawn the", "Shepherd the", "Sherlock the", "Shimmy the", "Shmooch the",
            "Shrapnel the", "Shredder the", "Sid the", "Sidney", "Silver the", "Skinner the", "Skipper the",
            "Skittles the", "Slate the", "Slick the", "Slimes the", "Slinky the", "Sly the", "Smeagol the",
            "Smiles the", "Smokey the", "Smooch the", "Smudge the", "Snapper the", "Snookums the", "Snowball the",
            "Snowflake the", "Snuffles the", "Snyder the", "Solace the", "Soots the", "Sparks the", "Sparky the",
...
nm2 = [[["Abalone", "Abby", "Acadia the", "Aerial the", "Aggie", "Aggy", "Agnes the", "Alexi", "Alexia", "Alexis",
         ...
         "Aspen the", "Astral", "Athena the", "Atilla the", "Atolle the", "Aura", "Aurora the", "Autumn",
         "Azraelle the", "Azura the", "Azure the", "Azurys the"],
        ["Angel", "Astronaut", "Alligator", "Ant", "Anaconda", "Ape"]], [
           ["Barbara", "Babe the", "Babes the", "Babette the", "Baby", "Badge the", "Bambi the", "Bambino",
            "Bandetta the", "Banshee the", "Bash the", "Bashful the", "Bashy the", "Batsy", "Batty", "Beauty the",
            "Becky", "Belchy the", "Bella", "Belle", "Bernice the", "Bertha the", "Bessy", "Beth the", "Betsy the",
            "Betty", "Biscuit the", "Bitsy the", "Blaze the", "Blinks the", "Blinky", "Blitz the", "Blitze the",
            "Blitzen the", "Bloats the", "Blossom the", "Blush the", "Bones the", "Bonnie", "Booboo", "Booboo the",
            "Boots the", "Boubou", "Bounce the", "Bouncy the", "Brandy", "Breeze the", "Breezy", "Brew the", "Brizzie",
            "Brooke the", "Brownie the", "Bubble the", "Bubbles the", "Buffy the", "Bullette the", "Bumble the",
            "Bumbles the", "Bunny the", "Buttercup", "Button the", "Buttons the"],
           ["Baboon", "Badger", "Bandicoot", "Bandit", "Bat", "Bear", "Beaver", "Bee", "Bigfoot", "Bird", "Bison",
            "Boar", "Buffalo"]], [
           ["Cake the", "Cakes the", "Calico the", "Calypso the", "Cami the", "Candy", "Capri the", "Cara the",
            "Caramel", "Caramelle", "Carapace", "Carmen the", "Cascade the", "Clacks the", "Clacky the", "Clarabella",
            "Clarice the", "Clarity", "Clawdia", "Claws the", "Clemency the", "Clementine", "Cleo the", "Cleopatra",
            "Clippy the", "Clips the", "Cloe the", "Clover the", "Cobbles the", "Coco the", "Codex the", "Comette the",
            "Cookie the", "Cora", "Coral the", "Coralia", "Coraline", "Corona", "Cosmo the", "Cotton the",
            "Crackle the", "Crackles the", "Crash the", "Creepette the", "Crunchey", "Crystal", "Cuddle the",
            "Cuddles thes", "Cupcake the", "Cushion the", "Cutie", "Karma the", "Kat the", "Kate the", "Kathy",
            "Kiss the", "Kisses the", "Kitty", "Kylla the"],
           ["Camel", "Cat", "Chameleon", "Cobra", "Cockroach", "Cougar", "Cow", "Coyote", "Crab", "Crane", "Croc",
            "Crow", "Kangaroo", "Koala", "Kobold", "Komodo"]], [
           ["Daahling the", "Daffodil the", "Dahlia", "Daisy the", "Dakota the", "Dandy", "Daphne the", "Darla the",
            "Darling", "Dash the", "Dashful the", "Dawn the", "Dawne the", "Dawnstar the", "Dazzle", "Dee the",
            "Deedee the", "Delilah the", "Delta the", "Destiny", "Dew the", "Dharma the", "Dirty", "Diva", "Diva the",
            "Dixie", "Dodger the", "Dolly", "Dora the", "Doris the", "Dot the", "Dots the", "Dottie the", "Dotty the",
            "Draculette", "Dream the", "Duchess", "Duchess the", "Duffy"],
           ["Dingo", "Dino", "Dodo", "Demon", "Dwarf", "Deer", "Dog", "Donkey", "Dragon", "Duck"]], [
           ["Ebony", "Echo the", "Eclipse the", "Eek the", "Eep the", "Elain the", "Eleanor", "Ember the", "Enigma the",
            "Enya the", "Equina the", "Equinox the", "Eve the"], ["Elf", "Eagle", "Elephant"]], [
           ["Faith the", "Fancy", "Fang the", "Fangie the", "Fangs the", "Faune the", "Faye the", "Fiddle the",
            "Fierra the", "Fire the", "Fizzle the", "Flame", "Flappy", "Flopsy the", "Flower the", "Flubby the",
            "Fluffy", "Fluffy the", "Flufkins the", "Flutters the", "Fortuna the", "Fortune the", "Frazzle", "Freakey",
            "Freckles the", "Frizzle the", "Fuzzles the", "Fuzzy", "Fye the", "Fyre the"],
           ["Phantom", "Falcon", "Ferret", "Fish", "Flamingo", "Fly", "Fox", "Frog", "Phoenix", "Fairy", "Pheasant"]], [
           ["Gadget the", "Gambles the", "Gargles the", "Gemini", "Gemma the", "Geo the", "Gertrude the", "Gia the",
            "Gidget the", "Giggles the", "Ginger the", "Ginny the", "Gloria", "Gobbles the", "Goldilocks", "Gooey",
            "Gorgeous the", "Grace the", "Gracie the", "Granny", "Gripes the", "Gummy the", "Gwen"],
           ["Gibbon", "Ghost", "Griffin", "Goat", "Goblin", "Goose", "Gopher", "Gator", "Gorilla"]], [
           ["Hailey the", "Happy the", "Happy", "Harley", "Harmony the", "Haze the", "Hazel the", "Heather the",
            "Heiress", "Helen the", "Helena", "Hermi the", "Hermine", "Hermione", "Hinda the", "Hippity",
            "Hipscotch the", "Honey the", "Hope the", "Hoppity", "Hugsie the", "Huntress the", "Hydris the", "Hymn the",
            "Hynde the", "Hyve the"],
           ["Hamster", "Hare", "Hawk", "Hedgehog", "Hippo", "Hog", "Hunter", "Horse", "Hound", "Human", "Hyena"]], [
           ["Jade the", "Jaffa the", "Jasmin the", "Jasmine the", "Jazzy", "Jess the", "Jewel the", "Jinx the",
            "Jitters the", "Juno the", "Jynx the"], ["Jackal", "Jaguar", "Giant"]], [
           ["Labyrinth the", "Lace the", "Lacy the", "Lady", "Laguna the", "Laika the", "Lana the", "Lane the",
            "Lavender", "Leaps the", "Leapy the", "Legs the", "Levi", "Lexis the", "Libby the", "Liberty", "Lilly the",
            "Linsey the", "Lola the", "Lore the", "Lotus the", "Lucky the", "Lucy the", "Lullaby", "Lulu the", "Lumina",
            "Luna the", "Lyla the", "Lyric the"],
           ["Lemming", "Lemur", "Leopard", "Lion", "Lizard", "Llama", "Lobster", "Locust", "Lynx"]], [
           ["Mable the", "Mae the", "Maggie", "Magnolia", "Maiden", "Malibu", "Mango the", "Maple the", "Marbles the",
            "Marigold", "Marinna", "Marsha the", "Martha the", "Maryn the", "Maxima", "Meadow the", "Medusa the",
            "Melancholy", "Melanie", "Mello", "Mellow", "Melody", "Mercy the", "Midnight the", "Mila the", "Milo the",
            "Mime the", "Minty the", "Mischief the", "Missy", "Mistress", "Misty the", "Mittens the", "Mocha",
            "Molly the", "Momma", "Mona the", "Momo the", "Moonbeam the", "Morticia the", "Muffin the", "Muriel",
            "Mysti the", "Mystique the", "Myth the"],
           ["Macaw", "Mandrill", "Mage", "Mutant", "Mantis", "Meerkat", "Mole", "Mongoose", "Mongrel", "Monkey",
            "Monster", "Moose", "Moth", "Mouse", "Mule"]], [
           ["Nahla the", "Nala the", "Nanook the", "Nebula", "Neko the", "Nell the", "Nemo the", "Nemoo the",
            "Neptuna the", "Nibbles the", "Nighte the", "Nipsey the", "Nixie the", "Noodle the", "Noodles the", "Nora",
            "Nova the", "Nugget the", "Nutmeg the", "Nymph the", "Nyx the"],
           ["Gnoll", "Gnome", "Numbat", "Nightingale", "Knight", "Ninja", "Nymph", "Neanderthal", "Newt"]], [
           ["Oasis", "Oasis the", "Oceana the", "Oceane the", "Olive the", "Olympia", "Omen the", "Onyxia the",
            "Opal the", "Oracle", "Orbit the", "Orchid the", "Oreo the", "Ozone the"],
           ["Oracle", "Orc", "Ocelot", "Octopus", "Ogre", "Orc", "Ostrich", "Owl"]], [
           ["Pace the", "Pandora the", "Paprika", "Patches the", "Patience the", "Paws the", "Peaches the", "Pearl the",
            "Pebble the", "Pebbles the", "Peeps the", "Penelope", "Penny the", "Pepper the", "Petunia", "Pickles the",
            "Pinky the", "Pitch the", "Pixie the", "Poison the", "Pookie the", "Popcorn the", "Poppy the",
            "Precious the", "Princess", "Prudence the", "Pudge the", "Pudgy the", "Puds the", "Puffy", "Pumpkin the",
            "Pyro the"],
           ["Panda", "Panther", "Pirate", "Parrot", "Peacock", "Pelican", "Penguin", "Pig", "Pigeon", "Piranha",
            "Polar Bear", "Pony", "Porcupine", "Possum", "Puma"]], [
           ["Rags the", "Raidrop the", "Rainbow the", "Raine the", "Raisin the", "Raleigh the", "Razzle the", "Rebel",
            "Rebel the", "Rhyme the", "Ria", "Ribbon the", "Ripley the", "Ripple", "Ripples the", "Riva", "River the",
            "Robin", "Rogue the", "Rogue", "Rose the", "Rosemary", "Rosie the", "Roxy", "Ruby the", "Rune the",
            "Ruth the"], ["Rabbit", "Ranger", "Rogue", "Raccoon", "Ram", "Rat", "Raven", "Rhino"]], [
           ["Sable the", "Sabre the", "Sabrina", "Sade the", "Saffron the", "Sage the", "Sally", "Salmone the",
            "Sandy the", "Sanguine the", "Sapphire", "Satin the", "Savanah the", "Scarlet the", "Psyche the",
            "Scratches the", "Scruffles the", "Selena", "Serenity", "Shade the", "Shadow the", "Shaye the",
            "Shelob the", "Shiba the", "Shmooches the", "Shye the", "Siera the", "Silver the", "Siren the", "Sirena",
            "Skylar the", "Sludges the", "Smooches the", "Smudges the", "Snappy the", "Snickers the", "Snoots the",
            "Snowball the", "Snuffles the", "Snuggles the", "Sona", "Sora the", "Sparkles the", "Speckles the",
            "Spice the", "Spindle the", "Squiggles the", "Stitches the", "Storme the", "Strawberry", "Stripes the",
            "Stuffles the", "Sugar", "Summer", "Sweetie", "Sweetpea the"],
           ["Salamander", "Satyr", "Scorpion", "Centipede", "Seal", "Shark", "Sheep", "Skunk", "Sloth", "Slug", "Snail",
            "Snake", "Centaur", "Scout", "Spy", "Sparrow", "Spider", "Squid", "Squirrel", "Stork", "Swallow", "Swan"]],
       [["Tabby the", "Tabitha", "Tawny the", "Teeny the", "Termina the", "Thistle the", "Tibby the", "Tickles the",
         "Tiggles the", "Tilly the", "Tinkerbell", "Tinkerbelle", "Tiny", "Theresa", "Toffee the", "Toots the",
         "Tootsie the", "Trixie the", "Trixy the", "Truffles the", "Tulip the", "Twiggy the", "Twinkie the",
         "Twinkles the", "Tyra the"],
        ["Tarantula", "Tiger", "Toad", "Tortoise", "Toucan", "Troll", "Turkey", "Turtle"]], [
           ["Valentine", "Vanilla the", "Vanity", "Vapor the", "Velvet the", "Venom the", "Venus the", "Victoria",
            "Viola", "Violet the", "Vixen the"], ["Viper", "Vampire", "Vulture"]], [
           ["Waddles the", "Waffles the", "Wendy", "Whisper the", "Wiggles the", "Wilde the", "Willow the",
...
class AnimatronicNameFactory(GenderNameFactory):
    ...
    class MaleAnimatronicNameFactory(NameFactory):
    ...
    class FemaleAnimatronicNameFactory(NameFactory):
        name_class = AnimatronicName
        blocks_map = {
            1: 2,
        }
    ...
    description = """There's a large variety of names in this generator. Some are normal, friendly names you'd expect
        for normal animatronics, other names are more creepy for the horror kinds of animatronics, like those in the
    ...
    factory_classes = {
        MALE: MaleAnimatronicNameFactory,
        FEMALE: FemaleAnimatronicNameFactory,
    }
