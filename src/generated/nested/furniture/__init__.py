...
new Thing("sink",[["porcelain","metal"],"OrganicMatter,5%","pipes"]);
new Thing("toilet",["Water","OrganicMatter,15%","pasta,0.1%","porcelain","pipes"]);
...
new Thing("pillow",["feather","Сloth"]);
