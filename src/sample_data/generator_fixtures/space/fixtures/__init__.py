from genesys.generator_models.space import SunType
from genesys.generator_models.space import PlanetAtmosphere, EarthPlanet, LayerPlanet, TerPlanet, MoonPlanet, GasPlanet, PlanetSize, SolarSystemSize, PlanetSubtype
...
planet_name_origins = [
    "%s, named so by its discoverer,",
    "%s, named after a famous scientist,",
    "%s, as it's called by most scientists,",
    "%s, which is a name which is still disputed,",
    "%s, which is a temporary placeholder name,",
    "%s, named so for the planet's properties,",
    "%s, named so for its similarities to the fictional version,",
]
intelligent_planet_name_origins = planet_name_origins + [
    "%s, as it's called by most of the natives,",
    "%s, the most popular name of the natives,",
...
planet_orbits = [
    "a circular orbit",
    "an almost perfectly circular orbit",
    "a slightly elliptic orbit",
    "a wide, elliptic orbit",
    "an elliptic orbit",
    "a fairly circular orbit",
]
planet_orbits_a = planet_orbits + ["narrow, elliptic orbit"]
...
basic_animals = [
    ...
    "While not as exciting as the animals we know on earth, this planet is home to a wide variety of insects, fish, reptiles and amphibians. While none of them have higher mind functions besides the basic needs to survive, they do show a wonderful insight into how this planet and planets in general give birth to life.",
...
advanced_animals = [
    ...
    "By far the most interesting animals on this planet are the aquatic mammals. They may not be as majestic as the birds or as fierce as some of the land mammals, but they are the only species who have a sentient member. This member of the aquatic species is roughly comparable to a mixture of seals and squids. They form huge colonies and actively take care of each other. They even build makeshift homes out of the available chemistry on the sea floors.",
