idiom = [
    ...
    "A demon fool",
    "A false alarm does mean harm",
    "A fool's test",
    "A garden of sticks",
    "A giant among ants",
    "A good plan's all you need",
    "A grim grin",
    "A home filled with light is a home of delight",
    "A hot meal in the cold is worth fivefold",
    "A hug can be warmer than a fire",
    "A knife is only as sharp as its wielder",
    "A laugh brings joy to more than the laughing",
    ...
    "A new night is a new day to some",
    "A payment of pennies",
    "A picnic on a rainy day",
    "A promise now broken is best not spoken",
    ...
    "A single wish can change the world",
    "A stranger today can be a friend tomorrow",
    "A suit of flowers",
    "A throne of thorns",
    ...
    "As the hour foretold",
    "Bargain of the devil",
    "Being sick on your birthday",
    "Being the mightiest mouse",
    ...
    "Heavy burdens leave a mark",
    "Hungry mouths have sharp teeth",
    "If a punishment doesn't reach, the punishment doesn't teach",
    "Imagination is a powerful ally",
    "Iron fists will rust eventually",
    "It has the logic of dreams",
    "It smells of dead flowers",
    "It's the face of a place",
    "Just a bump on my head",
    "Just curves and swerves",
    "Let design shine",
    "Like a cure for breathing",
    "Like a fight in the night",
    "Like a kiss in the night",
    "Like a light on the sun",
    "Like a new camp",
    "Like ants in a flood",
    "Like cooking with ice",
    "Like hearing colors",
    "Like learning from an echo",
    "Like painting with rainbows",
    "Like racing a snail",
    ...
    "Like trying to teach a fish to fly",
    "Like white clouds in a storm",
    "Live or not, life continues",
    "Living in limbo",
    "Living like a bear in winter",
    "Lost to the fires",
    "Love in my heart and love in my mind",
    "Making a lemon sweet",
    "Making a meal out of nothing",
    "Making a minute last a lifetime",
    "Making bread out of sand",
    "Making doors out of windows",
    ...
    "Not even bones",
    "Nothing is as snug as a loving hug",
    "Once the sun turns green",
    ...
    "Riding piggy back",
    "Running a marathon on water",
    "Saving it for yesterday",
    "Scratching an itch you don't have",
    "Seeing with a blind eye",
    "Shadows of the past can become shades of the present",
    ...
    "Some languages are known to all",
    "Speaking different languages",
    "Starting a fire in a rainstorm",
    "Stepping on land again",
    "Stopping a volcano with a cork",
    "Sweetening sugar",
    "Tears of my fears",
    ...
    "That's trusting a rumor",
    "The great taste of nothing",
    "The guest knows best",
    "The hopes of the devil",
    "The reaction matters more than the action",
    "The smallest toy can bring hours of joy",
    "The twinkle of my star",
    "There's more in a mine than precious metals",
    "There's no plan for madness",
    "Throwing rocks at a mountain",
    "To be in need is bittersweet",
    "To miss a kiss is to miss some bliss",
    "To practice putting horseshoes on a cow",
    ...
    "Winter clothing on a summer day",
    "Working for oblivion",
    "Writing a speech with a stick",
    "You can stop a clock, but time will tick on",
    "Your eyes can't see",
    "Chasing birds",
]