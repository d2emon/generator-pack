...
* future planet (FuturePlanet)
  ...
  * core <- (PlanetComposition)
* terraformed planet (TerraformedPlanet)
...
new Thing("nested",["universe"],"www.orteil.dashnet.org/nested");  // to Universe
...
new Thing("medieval thoughts",["black hole,0.01%", ["medieval thought,2-3"]],"thoughts"); // With Black Hole
...
new Thing("future thoughts",["black hole,0.01%", ["future thought,2-3"]],"thoughts"); // With Black Hole
...
new Thing("ancient thoughts",["black hole,0.01%", ["ancient thought,2-3"]],"thoughts"); // With Black Hole
...
new Thing("consolation universe",[".universe"]);  // to Universe
